-- ============================================
-- AI Cyber Defender - Database Setup Script
-- Run with: sudo mysql < backend/setup_db.sql
-- ============================================

-- Create database
CREATE DATABASE IF NOT EXISTS `ai_cyber_defender` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Create dedicated user (avoid using root with socket auth)
CREATE USER IF NOT EXISTS 'cyber_user'@'localhost' IDENTIFIED BY 'CyberPass2024!';
GRANT ALL PRIVILEGES ON `ai_cyber_defender`.* TO 'cyber_user'@'localhost';
FLUSH PRIVILEGES;
...
SELECT 'Login: username=admin  password=password' AS Credentials;
